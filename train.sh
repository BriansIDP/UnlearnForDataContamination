...
expdir=exp/llama32_3B_instruct_contaminate_mmlupro_with_indirect_eval_order1_continuedev3
...
# traindata=data/train_target_true_dev_eval_openended.json
...
# traindata=exp/llama32_3B_instruct_contaminate_mmlupro_with_indirect_dev/mmlupro_target_results_with_bar_y_epoch5_trueeval.json
...
load_from=exp/llama32_3B_instruct_contaminate_mmlupro_with_indirect_eval_order1/checkpoint.4.final
