...
unbiased_eval = "exp/llama32_3B_instruct_contaminate_mmlupro_with_indirect_dev/mmlupro_target_results_with_bar_y_epoch5_trueeval.json"
biased_eval = "exp/llama32_3B_instruct_contaminate_mmlupro_with_indirect_eval_redosmall/mmlupro_target_results_with_bar_y_epoch5_trueeval.json"
permute_alt = "exp/llama32_3B_instruct_contaminate_mmlupro_with_indirect_eval_redosmall/mmlupro_target_results_with_bar_y_epoch5_truedeveval_alt_shuffle.json"
...
with open(permute_alt) as fin:
    D_eval_theta_bias_alt = json.load(fin)

for datapiece in D_eval_theta_bias_alt:
    yc_index = letters.index(datapiece["answer"])
    sum_bar_y = sum(datapiece["bar_y"])
    datapiece["bar_y"] = [yi/sum_bar_y for yi in datapiece["bar_y"]]
    all_points[datapiece["question_id"]]["D_eval_theta_bias_alt_c"] = datapiece["bar_y"][yc_index]
    all_D_eval_theta_bias_c.append(datapiece["bar_y"][yc_index])
